...
<script language="javascript">
	...
	function getAddr() {
		...
		jQuery.ajax({
			...
			, data : {
				  ...
				  confmKey : "devU01TX0FVVEgyMDIwMTEwMzE4MTI1NzExMDM2NTQ="
	...
	function inputTextAddress(zipNo, address) {
	...
	function formCheck() {
		...
		var address = document.getElementById("address").value; // 도로명 주소
		var detail = document.getElementById("detail").value; 	// 상세 주소
		var zipNo = document.getElementById("zipNo").value; //지번주소
		
		opener.document.getElementById("roadAddrPart1").value = address;	// 부모의 도로명
		opener.document.getElementById("addrDetail").value = detail;
...
<body>
	...
	<form>
		<input type="text" id="zipNo" value="" onClick="addressWindowOpen();"  readonly/>
		...
		<br>
		<input type="button" value="주소 등록" onclick="formCheck();">
	</form>
</body>
